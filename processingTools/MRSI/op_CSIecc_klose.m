function [MRSISupressed, MRSIUnsupressed] = op_CSIecc_klose(MRSISupressed, MRSIUnsupressed)
    ...
    for e = 1:getSizeFromDimensions(MRSISupressed, {'extras'})
        for y = 1:getSizeFromDimensions(MRSISupressed, {'y'})
            for x = 1:getSizeFromDimensions(MRSISupressed, {'x'})
                ...
                [mrsUnsupressed, mrsSupressed] = op_ecc_klose(mrsUnsupressed, mrsSupressed);
