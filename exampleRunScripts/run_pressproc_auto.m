% run_pressproc_auto.m
% Jamie Near, McGill University 2014.
% 
% USAGE:
% [out,out_w,out_noproc,out_w_noproc]=run_pressproc_auto(filestring,aaDomain,tmaxin,iterin);
% 
% DESCRIPTION:
% Fully automated processing script for Siemens PRESS MRS data in .dat 
...
function [out,outw,out_noproc,outw_noproc]=run_pressproc_auto(filestring,aaDomain,tmaxin,iterin);
...
%Find the filename of the PRESS dataset
close all
